...
# Path to the Audio_File directory
c = r"C:\\Users\\lenovo\\Desktop\\HTN\\Speech-Evaluation-Tool\\FlaskApp\\assets"
...
def speech_processing():
    ...
    print(pronunciation_score,filler_pause_count,speech_speed,articulation_rating)
    pronunciation_score = float(pronunciation_score.split(" = ")[1])
    filler_pause_count = float(filler_pause_count.split(" = ")[1])
    speech_speed = float(speech_speed.split(" = ")[1])
    articulation_rating = float(articulation_rating.split(" = ")[1])
    return([pronunciation_score,filler_pause_count,speech_speed,articulation_rating])
#
